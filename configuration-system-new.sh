...
install_other_softwares(){
	...
	wget -O google-chrome-stable_current_amd64.deb -P $HOME/Scaricati/Softwares/https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb
	...
	wget -O VNC-Viewer-6.20.259-Linux-x64.deb -P $HOME/Scaricati/Softwares https://www.realvnc.com/download/file/viewer.files/VNC-Viewer-6.20.529-Linux-x64.deb
